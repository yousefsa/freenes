...
جميع اوامر البوت 
❖الاوامرالعامة
❖حتى تقدم على الرتبة المتاحة : تقديم
❖bot : لمعرفة معلوامات حول البوت
❖report : لعمل شكوة في احد من الاعضاء
❖sugg : لعمل اقتراح
❖link : للحصول على رابط للسيرفير
❖rules : لمعرفة قوانين السيرفير
❖user : وقت دخولك سيرفرنا او الديسكورد عموما
❖id : لمعرفة جميع المعلومات حولك
❖avatar : لنشر صورتك او اخذ صورة احد
❖ping : لمعرفة البنق الخاص ب البوت
❖❖❖❖❖❖❖❖❖❖❖❖❖❖❖❖❖❖❖❖❖
❖اوامر ادارية
❖hide : لاخفاء الرومات
...
❖clear : لمسح الشات
❖server : لمعرفة معلومات حول السيرفير
❖bc : لارسال رسالة للجميع
❖bco : لارسال رسالة الى الاونلين فقط
❖mute : لعمل ميوت لشخص من السيرفير
...
client.on('message', message => {
  ...
  .setColor("#8650a7")
  .addField("Done" , " تــــم ارسـالها في الخــاص")
             .setFooter(message.author.username, message.author.avatarURL)
...
client.on('message', msg => {
 if (msg.content.startsWith('*' + 'send')) {/////////////////////Alpha Codes   By : Mahmoud QuaStyle 
      ...
      .setTitle(`**رسالة مهمة من صاحب البوت**`)
...
client.on('message',function(message) {
  ...
  const swearWords = ["يا منتاك","يا قحبه","يا عرص","كس امك","كسمك","ياعرص","يابن العرص","يامتناك"];
...
.addField('    سادسا' ,' لا تنشر في الشات او بل خاص ')//youssef
  ...
  client.on('message', msg => {
    ...
    message.channel.send({
        embed: new Discord.RichEmbed()
            ...
            .addField('**Bot Owner**👑 :' , `[<@519925557882781698>]` , true)
            .setFooter(message.author.username, message.author.avatarURL)
    })
}
});
...
if (command == "mute") {
if (!message.channel.guild) return;
if(!message.guild.member(message.author).hasPermission("MANAGE_MESSAGES")) return message.reply("انت لا تمتلك صلاحيه ").then(msg => msg.delete(5000));
...
client.on('message', message => {
  ...
  .bannable) return message.reply("**انا مقدرش اطرد حد في نفس رتبتي او اعلى مني**");
